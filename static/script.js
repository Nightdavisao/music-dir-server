(function () {
  ...
  var global$1F = // eslint-disable-next-line es/no-global-this -- safe
  ...
  var TypeError$v = global$1D.TypeError; // `RequireObjectCoercible` abstract operation
  ...
  var TypeError$u = global$1y.TypeError; // `Assert: IsCallable(argument) is true`
  ...
  var TypeError$t = global$1x.TypeError; // `OrdinaryToPrimitive` abstract operation
  ...
  var global$1w = global$1F; // eslint-disable-next-line es/no-object-defineproperty -- safe

  var defineProperty$h = Object.defineProperty;

  var setGlobal$3 = function (key, value) {
    try {
      defineProperty$h(global$1w, key, {
        value: value,
        configurable: true,
        writable: true
      });
  ...
  var Object$4 = global$1u.Object; // `ToObject` abstract operation
  ...
  var document$3 = global$1r.document; // typeof document.createElement is 'object' in old IE
  ...
  var TypeError$r = global$1q.TypeError; // `Assert: Type(argument) is Object`
  ...
  var TypeError$q = global$1p.TypeError; // eslint-disable-next-line es/no-object-defineproperty -- safe
  ...
  var WeakMap$2 = global$1o.WeakMap;
  ...
  var WeakMap$1 = global$1n.WeakMap;
  var set$3, get$2, has;
  ...
  var objectKeysInternal = function (object, names) {
    ...
    for (key in O) !hasOwn$o(hiddenKeys$4, key) && hasOwn$o(O, key) && push$d(result, key); // Don't enum bug & hidden keys
  ...
  */
  ...
  var Object$3 = global$1k.Object; // ES3 wrong here
  ...
  var Array$8 = global$1g.Array; // a part of `ArraySpeciesCreate` abstract operation
  ...
  var TypeError$k = global$17.TypeError; // We can't use this feature detection in V8 since it causes
  // deoptimization and serious performance degradation
  ...
  var TypeError$j = global$16.TypeError; // `FlattenIntoArray` abstract operation
  ...
  var Array$7 = global$15.Array; // `Array.from` method implementation
  ...
  var TypeError$i = global$13.TypeError; // `Array.prototype.{ reduce, reduceRight }` methods implementation
  ...
  var RangeError$d = global$_.RangeError; // `ToIndex` abstract operation
  ...
  var NativeArrayBuffer = global$X[ARRAY_BUFFER]; // `ArrayBuffer` constructor
  ...
  var TypeError$e = global$V.TypeError; // `Assert: IsConstructor(argument) is true`
  ...
  var RangeError$b = global$T.RangeError; // `String.prototype.repeat` method implementation
  ...
  var TypeError$d = global$R.TypeError; // `Date.prototype[@@toPrimitive](hint)` method implementation
  ...
  var $$1V = _export;
  var global$P = global$1F; // `globalThis` object
  ...
  var globalIsFinite = global$K.isFinite; // `Number.isFinite` method
  ...
  var RangeError$9 = global$H.RangeError;
  var String$3 = global$H.String;
  var isFinite$1 = global$H.isFinite;
  var abs = Math.abs;
  ...
  $$1q({
    ...
    toFixed: function toFixed(fractionDigits) {
      ...
      if (fractDigits < 0 || fractDigits > 20) throw RangeError$8('Incorrect fraction digits'); // eslint-disable-next-line no-self-compare -- NaN check
  ...
  if (!set$1 || !clear) {
    ...
    } else if (global$C.addEventListener && isCallable$9(global$C.postMessage) && !global$C.importScripts && location && location.protocol !== 'file:' && !fails$u(post)) {
      defer = post;
  ...
  var fails$o = fails$1f;
  var global$w = global$1F; // babel-minify and Closure Compiler transpiles RegExp('a', 'y') -> /a/y and it causes SyntaxError
  ...
  var global$v = global$1F; // babel-minify and Closure Compiler transpiles RegExp('.', 's') -> /./s and it causes SyntaxError
  ...
  var fails$m = fails$1f;
  var global$u = global$1F; // babel-minify and Closure Compiler transpiles RegExp('(?<a>b)', 'g') -> /(?<a>b)/g and it causes SyntaxError
  ...
  var TypeError$9 = global$s.TypeError; // `RegExp.prototype.dotAll` getter
  ...
  var TypeError$8 = global$r.TypeError; // `RegExp.prototype.sticky` getter
  ...
  var RangeError$7 = global$o.RangeError;
  ...
  var TypeError$6 = global$n.TypeError; // `RegExpExec` abstract operation
  ...
  var RangeError$6 = global$j.RangeError;
  ...
  var task = task$2;
  var FORCED = !global$8.setImmediate || !global$8.clearImmediate; // http://w3c.github.io/setImmediate/
  ...
  var process = global$7.process; // `queueMicrotask` method
  ...
  var checkNewErrorsSemantic = function (structuredCloneImplementation) {
    return !fails$1(function () {
      var test = structuredCloneImplementation(new global$6.AggregateError([1], PERFORMANCE_MARK, {
        cause: 3
      }));
  ...
  var structuredCloneInternal = function (value, map) {
    ...
    switch (type) {
      ...
      case 'BigInt64Array':
      case 'BigUint64Array':
        C = global$6[type]; // in some old engines like Safari 9, typeof C is 'object'
      ...
      default:
        if (nativeRestrictedStructuredClone) {
          ...
          case 'ArrayBuffer':
            C = global$6.DataView; // `ArrayBuffer#slice` is not available in IE10
  ...
  var imagesRgx = /\.(png|jpg|gif|jpeg)$/i;
  var Router = /*#__PURE__*/function () {
    function Router(tBody, imagesContainer, player) {
      var _this = this;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.fetchPath(window.location.href);
      ...
      this.player.nowPlayingText.addEventListener('click', function (e) {
        e.preventDefault();

        _this.navigateTo(_this.player.getCurrentTrack().location);
      });
    }

    _createClass(Router, [{
      key: "sendHistoryState",
      value: function sendHistoryState() {
      ...
      value: function setPath(path) {
        this.path = path;
        var title = "Index of ".concat(decodeURIComponent(new URL(path).pathname));
        document.title = title;
      }
    }, {
      key: "grabImages",
      value: function grabImages(html) {
        var images = [];
        var parsedHtml = this.domParser.parseFromString(html, "text/html");
        var elements = parsedHtml.getElementsByClassName("fileitem");
      ...
      key: "fetchPage",
      value: function () {
        var _fetchPage = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(location) {
          var res, path, html;
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 3:
                  res = _context2.sent;
                  path = res.headers.get("X-PJAX-URL");
                  _context2.next = 7;
                  return res.text();
                ...
                case 11:
                  ...
                  console.error("Failed to fetch page", _context2.t0);
      ...
      key: "setTableContent",
      value: function setTableContent(html) {
        this.tBody.innerHTML = html;
        var elements = document.getElementsByClassName("fileitem");

        if (this.player.trackListing.length > 0) {
          for (var i = 0; i < elements.length; i++) {
            var element = elements[i];
            var currentTrack = this.player.getCurrentTrack();
      ...
      key: "fetchPath",
      value: function () {
        var _fetchPath = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(location) {
          var fetchedPage;
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  _context3.next = 2;
                  return this.fetchPage(location);

                case 2:
                  fetchedPage = _context3.sent;
      ...
      key: "navigateTo",
      value: function () {
        var _navigateTo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(location) {
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  _context4.prev = 0;
                  _context4.next = 3;
                  return this.fetchPath(location);
  ...
  var isMediaSessionEnabled = ('mediaSession' in navigator);
  var rgx = /\.(mp3|ogg|wav|flac|m4a)$/i;
  var Player = /*#__PURE__*/function () {
    function Player(tbody) {
    ...
    _createClass(Player, [{
      ...
      value: function _addEventListeners() {
        ...
        this.audio.addEventListener('play', function () {
          ...
          _this.setMetadata(decodeURIComponent(src.substring(src.lastIndexOf("/") + 1, src.length)));
        });
      ...
      key: "addItemsFromCurrentList",
      value: function addItemsFromCurrentList() {
        var elements = document.getElementsByClassName("fileitem");
      ...
      key: "_listenForMediaKeys",
      value: function _listenForMediaKeys() {
        var _this2 = this;

        if (isMediaSessionEnabled) {
          navigator.mediaSession.setActionHandler('nexttrack', function () {
            return _this2.playNextTrack();
          });
          navigator.mediaSession.setActionHandler('previoustrack', function () {
            return _this2.playPreviousTrack();
          });
        }
      }
    }, {
      key: "updateTableCurr",
      value: function updateTableCurr() {
        var elements = document.getElementsByClassName("fileitem");
      ...
      key: "setMetadata",
      value: function () {
        var _setMetadata = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
          var title,
              _args = arguments;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  title = _args.length > 0 && _args[0] !== undefined ? _args[0] : null;
      ...
      key: "setCurrentTrack",
      value: function setCurrentTrack(index) {
      ...
      key: "attachPlayer",
      value: function attachPlayer(floating) {
        var _this3 = this;
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var router = new Router(tbody, imagesContainer, player);
    tbody.addEventListener("click", /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                index = player.trackListing.map(function (item) {
                  return item.track;
                }).indexOf(e.target.href);
